...
use crate::app::EkokeLiquidityPoolCanister;
...
impl HttpApi {
    ...
    async fn liquidity_pool_balance() -> HttpResponse {
        let response = match EkokeLiquidityPoolCanister::liquidity_pool_balance().await {
    ...
    fn liquidity_pool_accounts() -> HttpResponse {
        let params = EkokeLiquidityPoolCanister::liquidity_pool_accounts();
