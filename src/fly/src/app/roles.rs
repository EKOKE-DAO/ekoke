...
use did::fly::{ConfigurationError, FlyError, FlyResult, Role, Roles};
...
impl RolesManager {
    ...
    pub fn set_admins(admins: Vec<Principal>) -> FlyResult<()> {
        ...
        {
            return Err(FlyError::Configuration(ConfigurationError::AnonymousAdmin));
        }
    ...
    pub fn remove_role(principal: Principal, role: Role) -> FlyResult<()> {
